...
val MIGRATION_4_5 = object : Migration(4, 5) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("CREATE TABLE IF NOT EXISTS `active_id` (`type` TEXT NOT NULL, `id` INTEGER NOT NULL, PRIMARY KEY(`type`))")
        ...
        database.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '1a56b8c34a8fb175fb26f7a67e6208a4')")
    }
}