...
class MawDatabaseCreateCallback : Callback() {
    override fun onCreate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("INSERT INTO search_preference (id, recent_query_count, display_type, grid_thumbnail_size) VALUES (1, 24, '${CategoryDisplayType.Grid}', '${GridThumbnailSize.Medium}')")
    }
}