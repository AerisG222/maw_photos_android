...
class CategoryChooserFragment: Fragment() {
    ...
    private val onGridItemClicked = { imageGridItem: ImageGridItem ->
        onSelectCategory(imageGridItem.data as PhotoCategory)
    }

    private val onListItemClicked = CategoryClickListener {
        onSelectCategory(it)
    }
